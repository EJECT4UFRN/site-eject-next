...
import { Container, Wrapper, Aside } from "../../styles/templates/Success";
...
export default function Success({ linkWhats, edition }: SuccessProps) {
  ...
  useEffect(() => {
    toast.success("Você está inscrito! 🚀🎊", {
      autoClose: 5000,
      bodyStyle: {
        color: "#fff",
      },
  ...
  return (
    <>
      <Head>
        <title>Inscrição realizada | ProSempre {edition}</title>
      </Head>
      <Container ref={confettiRef}>
        ...
        <Wrapper>
          <div>
            <img src="/images/3d-rocket.png" alt="Imagem de um foguete" />
          </div>
          <Aside>
            <div>
              <svg
            ...
            <h3>
              Seja bem-vindo futuro astronauta ao processo seletivo {edition}
            </h3>
            <p>
              Entrem em contato por nosso whatsapp e fiquem ligados em todas as
              novidades pelas nossas redes sociais
            </p>
            <a href={linkWhats}>
              <svg
                fill="#FF9E16"
